...
export class WorkbookFormComponent implements AfterViewInit {
  ...
  imgUnchecked: string = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAd0lEQVRIS2NkoDFgpLH5DHS3wJuBgWEOAwODBJk+e8HAwJDEwMCwHaYf3QfPKTAcZibIEklcFvyHSpAbdBj60Q0atWA0iAjmjtEgGg0iBoahX1TQvLh2Z2BgWEBBnQCqCxIYGBh24qoPCKZDUhWQW7EQbQ/NLQAA/3AmGU5fSQYAAAAASUVORK5CYII=';
  imgChecked: string = 'data:image/png;base64,'
  b1_intro: string;
  sectionHeading: any[];
  blockHeading: any[];
  blockText: any[];
